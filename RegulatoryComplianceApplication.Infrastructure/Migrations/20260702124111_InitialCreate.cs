...
namespace RegulatoryComplianceApplication.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "DocumentResponsibleUsers",
                columns: table => new
                {
                    DocumentId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    IsUploader = table.Column<bool>(type: "bit", nullable: false),
                    AddedByUserId = table.Column<int>(type: "int", nullable: false),
                    AddedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentResponsibleUsers", x => new { x.DocumentId, x.UserId });
                    table.ForeignKey(
                        name: "FK_DocumentResponsibleUsers_Users_AddedByUserId",
                        column: x => x.AddedByUserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DocumentResponsibleUsers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentResponsibleUsers_AddedByUserId",
                table: "DocumentResponsibleUsers",
                column: "AddedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentResponsibleUsers_UserId",
                table: "DocumentResponsibleUsers",
                column: "UserId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_DocumentResponsibleUsers_Documents_DocumentId",
                table: "DocumentResponsibleUsers",
                column: "DocumentId",
                principalTable: "Documents",
                principalColumn: "DocumentId",
